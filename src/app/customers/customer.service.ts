...
export class CustomerService {
  ...
  queryRef: AngularFireList<Customer> = null;
  ...
  getQueryList(query: string): AngularFireList<Customer> {
    this.queryRef = this.db.list(this.dbPath, ref => ref.orderByChild('firstName').equalTo(query));
